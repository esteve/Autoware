...
#include <autoware_detection_msgs/Waypoint.h>
...
private:
  ...
  autoware_detection_msgs::Lane current_finalwaypoints_;
  ...
  autoware_detection_msgs::LaneArray current_based_lane_array_;       // with wpstate
  autoware_detection_msgs::LaneArray current_shifted_lane_array_;     // with shiftedLane
  autoware_detection_msgs::LaneArray current_controlled_lane_array_;  // modified lane
  autoware_detection_msgs::LaneArray current_stopped_lane_array_;     // 0velocity
  ...
  autoware_detection_msgs::Waypoint CurrentStoplineTarget_;
  ...
  bool isCrossRoadByVectorMapServer(const autoware_detection_msgs::Lane &lane_msg, const geometry_msgs::PoseStamped &pose_msg);
  ...
  double calcIntersectWayAngle(const autoware_detection_msgs::Lane &laneinArea);

  void insertPointWithinCrossRoad(const std::vector<CrossRoadArea> &_intersects, autoware_detection_msgs::LaneArray &lane_array);

  void setWaypointState(autoware_detection_msgs::LaneArray &lane_array);
  ...
  void callbackFromFinalWaypoint(const autoware_detection_msgs::Lane &msg);
  void callbackFromLaneWaypoint(const autoware_detection_msgs::LaneArray &msg);
