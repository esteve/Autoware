...
void fusion_cb(const autoware_detection_msgs::ObjLabel::ConstPtr &obj_label_msg,
...
int main(int argc, char *argv[])
{
  ...
  typedef message_filters::sync_policies::ApproximateTime<autoware_detection_msgs::ObjLabel, autoware_detection_msgs::CloudClusterArray>
      SyncPolicy;
  message_filters::Subscriber<autoware_detection_msgs::ObjLabel> obj_label_sub(n, "obj_label", SUBSCRIBE_QUEUE_SIZE);
