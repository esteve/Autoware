...
namespace integrated_viewer {
    ...
    const QString     ImageViewerPlugin::kPointDataType                 = "autoware_detection_msgs/PointsImage";
    ...
    void ImageViewerPlugin::on_point_topic_combo_box__activated(int index) {
        ...
        // if selected topic is not blank or empty , start callback function
        point_sub_ = node_handle_.subscribe<autoware_detection_msgs::PointsImage>(selected_topic,
                                                                        1,
    ...
    void ImageViewerPlugin::PointCallback(const autoware_detection_msgs::PointsImage::ConstPtr &msg) {
        points_msg_ = msg;
    } // ImageViewerPlugin::PointCallback()
