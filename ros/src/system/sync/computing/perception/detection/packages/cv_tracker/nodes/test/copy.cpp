...
void obj_person__image_obj_callback(const autoware_image_msgs::ImageObj::ConstPtr& image_obj_msg) {
...
void obj_car__image_obj_callback(const autoware_image_msgs::ImageObj::ConstPtr& image_obj_msg) {
...
void vscan_image_callback(const autoware_image_msgs::PointsImage::ConstPtr& points_image_msg) {
    if (vscan_image_flag) {
        obj_person__image_obj_flag = false;
        obj_car__image_obj_flag = false;
        points_image_flag = false;
