...
int main(int argc, char **argv) {
    ...
    image_obj__pub = nh.advertise<autoware_image_msgs::ImageObj>("obj_car/image_obj_", 5);
    vscan_image__pub = nh.advertise<autoware_image_msgs::PointsImage>("vscan_image_", 5);
